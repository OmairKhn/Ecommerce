...
export const Cart = () => {
  ...
  const buyNow = async () => {
    ...
    var options = {
      ...
      handler: function (response) {
        ...
        try {
          // Add your order saving logic here
        } catch (error) {
          console.log(error);
        }
      },
  ...
  return (
    <Layout>
      <div
        className="min-h-screen pt-5 flex flex-col justify-between"
          ...
          <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
            <div className="rounded-lg md:w-2/3">
              {cartItems.map((item, index) => {
                const { title, price, describtion, imageUrl } = item;
                return (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                      <div className="mt-5 sm:mt-0">
                        ...
                        <h2 className="text-sm text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>{describtion}</h2>
