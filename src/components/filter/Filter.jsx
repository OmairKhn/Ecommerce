...
function Filter() {
    ...
    const resetFilters = () => {
        ...
        setFilterPrice('');  // Reset filter price
    };
    ...
    const uniqueCategories = getUniqueValues(product, 'category');
    const uniquePrices = getUniqueValues(product, 'price');
